...
By submitting a manuscript to ECCV, the author(s) assert that it has
...
during the ECCV 2010 review period to either a journal or a
conference.
...
ECCV 2010 first paper submission. 
...
\par\vfill\par
Now we have reached the maximum size of the ECCV 2010 submission.
\end{document}
